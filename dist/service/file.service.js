...
const uploadFileService = (_a) => __awaiter(void 0, [_a], void 0, function* ({ buffer, contentType, existingFilename, }) {
    if (existingFilename) {
...
const deleteFileService = (_a) => __awaiter(void 0, [_a], void 0, function* ({ filename }) {
